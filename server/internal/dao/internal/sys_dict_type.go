...
// SysDictTypeDao is the data access object for the table xy_sys_dict_type.
...
// SysDictTypeColumns defines and stores column names for the table xy_sys_dict_type.
...
// sysDictTypeColumns holds the columns for the table xy_sys_dict_type.
