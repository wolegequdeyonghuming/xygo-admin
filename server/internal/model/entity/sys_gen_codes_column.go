...
type SysGenCodesColumn struct {
	...
	IsAutoIncrement int    `json:"isAutoIncrement" orm:"is_auto_increment" description:"是否自增"`                       // 是否自增
	IsNullable      int    `json:"isNullable"      orm:"is_nullable"       description:"是否可空"`                       // 是否可空
