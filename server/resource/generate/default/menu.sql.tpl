...
VALUES (0, 1, '{{.TableComment}}', '{{.VarName}}Dir', '/{{.ModulePath}}', '', '', '{{.MenuIcon}}', 0, 0, '', '', '', 0, 0, 0, '', '', 0, 0, {{.MenuSort}}, 1, '', 0, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());

SET @parentId = LAST_INSERT_ID();

-- 2. 创建页面菜单
INSERT INTO `xy_admin_menu` (`parent_id`, `type`, `title`, `name`, `path`, `component`, `resource`, `icon`, `hidden`, `keep_alive`, `redirect`, `frame_src`, `perms`, `is_frame`, `affix`, `show_badge`, `badge_text`, `active_path`, `hide_tab`, `is_full_page`, `sort`, `status`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`)
VALUES (@parentId, 2, '{{.TableComment}}列表', '{{.VarName}}', '{{.ModulePath}}', '{{.MenuComponentPath}}/index', '{{.ResourceName}}', '', 0, 1, '', '', '["GET {{.ApiPrefix}}/list"]', 0, 0, 0, '', '', 0, 0, 1, 1, '{{.MenuRemark}}', 0, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
...
INSERT INTO `xy_admin_menu` (`parent_id`, `type`, `title`, `name`, `path`, `component`, `resource`, `icon`, `hidden`, `keep_alive`, `redirect`, `frame_src`, `perms`, `is_frame`, `affix`, `show_badge`, `badge_text`, `active_path`, `hide_tab`, `is_full_page`, `sort`, `status`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`)
VALUES ({{.MenuPid}}, 2, '{{.TableComment}}', '{{.VarName}}', '{{.ModulePath}}', '{{.MenuComponentPath}}/index', '{{.ResourceName}}', '{{.MenuIcon}}', 0, 1, '', '', '["GET {{.ApiPrefix}}/list"]', 0, 0, 0, '', '', 0, 0, {{.MenuSort}}, 1, '{{.MenuRemark}}', 0, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
